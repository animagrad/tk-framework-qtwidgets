...
class LargeAttachmentThumbnail(ClickableLabel):
    ...
    def __init__(self, data, parent):
        ...
        if self._data["image"]:
            ...
            self.setToolTip(
                "Click to see full attachment.<br>"
            ...
            self.setPixmap(
                QtGui.QPixmap(
                    ":/tk_framework_qtwidgets.activity_stream/rect_256x144.png"
                )
            )
...
class SmallAttachmentThumbnail(ClickableLabel):
    ...
    def __init__(self, data, parent):
        ...
        self.setPixmap(
            QtGui.QPixmap(
                ":/tk_framework_qtwidgets.activity_stream/attachment_icon_192px.png"
            )
        )
        self._data = data
